...
$('.js-calc-minus').on('click touch', function() {
	var $val = $('#currency_calc');
	var newValue = Number($val.val()) - Number($val.data('step'));
...
$('#currency_calc').on('keyup keydown change', function() {
	if($(this).val() < 0) {$(this).val('0');}
	$('#calc_result').text(round($(this).val() * $('#calc_price').val()));
	if($('#bonus_percent').val()>0){$('#calc_result_bonus').text(round($(this).val() * $('#calc_price').val() * $('#bonus_percent').val()));}
});
...
$.ajax({
    ...
    beforeSend: function() {
        ...
        $('#admin-token_decimals-error').hide();
    ...
    success: function(result) {
		...
		if (result.status == 'token_decimals'){$('#admin-token_decimals-error').html(result.message);$('#admin-token_decimals-error').show();}
...
$.ajax({
    ...
    success: function(result) {
		...
		if (result.status == 'other_raised'){$('#admin-other_raised-error').html(result.message);$('#admin-other_raised-error').show();}
...
$('#admin_search_referral_link-button').click(function(e) {
	
    e.preventDefault();
    e.stopImmediatePropagation();

var data = $('#admin_search_referral_link-form').serialize();
...
$.ajax({
    ...
    data: data,
    beforeSend: function() {
        $('#admin_search_referral_link-button').prop('disabled', true);
		$('#admin_search_referral_link-button').hide();
		$('#admin_search_referral_link-loading').show();
        $('#admin-referral_link-error').hide();
    },
    success: function(result) {
        $('#admin_search_referral_link-button').prop('disabled', false);
		$('#admin_search_referral_link-button').show();
		$('#admin_search_referral_link-loading').hide();
		...
		if(result.message=='user'){
			$('#RLI_url_title').hide();
			$('#RLI_url').hide();
			$('#RLI_comment_title').hide();
			$('#RLI_comment').hide();
			$('#RLI_id_title').show();
			$('#RLI_id').show();
			$('#RLI_time_title').show();
			$('#RLI_time').show();
			$('#RLI_email_title').show();
			$('#RLI_email').show();
			$('#RLI_country_code_title').show();
			$('#RLI_country_code').show();
			$('#RLI_referral_balance_title').show();
			$('#RLI_referral_balance').show();
			
			$('#RLI_id').html(result.id);
			$('#RLI_time').html(result.time);
			$('#RLI_email').html(result.email);
			$('#RLI_country_code').html(result.country_code);
			$('#RLI_referrals').html(result.referrals);
			$('#RLI_referrals_buyers').html(result.referrals_buyers);
			$('#RLI_referral_visits').html(result.referral_visits);
			$('#RLI_referral_visits_portal').html(result.referral_visits_portal);
			$('#RLI_referral_visits_external').html(result.referral_visits_external);
			$('#RLI_referral_wp').html(result.referral_visits_wp);
			$('#RLI_referral_balance_value').html(result.referral_balance);
			$('#RLI_referral_raised').html(result.referral_raised);
		}
		
		if(result.message=='link'){
			$('#RLI_url_title').show();
			$('#RLI_url').show();
			$('#RLI_comment_title').show();
			$('#RLI_comment').show();
			$('#RLI_id_title').hide();
			$('#RLI_id').hide();
			$('#RLI_time_title').hide();
			$('#RLI_time').hide();
			$('#RLI_email_title').hide();
			$('#RLI_email').hide();
			$('#RLI_country_code_title').hide();
			$('#RLI_country_code').hide();
			$('#RLI_referral_balance_title').hide();
			$('#RLI_referral_balance').hide();
			
			$('#RLI_url').html(result.url);
			$('#RLI_comment').html(result.comment);
			$('#RLI_referrals').html(result.referrals);
			$('#RLI_referrals_buyers').html(result.referrals_buyers);
			$('#RLI_referral_visits').html(result.referral_visits);
			$('#RLI_referral_visits_portal').html(result.referral_visits_portal);
		...
		$('#referral_link_info').show();
		return true;}
        if (result.status == 'referral_link') {
		$('#admin-referral_link-error').html(result.message);
		$('#admin-referral_link-error').show();
		}
...
$('#admin_create_referral_link-button').click(function(e) {
	
    e.preventDefault();
    e.stopImmediatePropagation();

var data = $('#admin_create_referral_link-form').serialize();
...
$.ajax({
    ...
    data: data,
    beforeSend: function() {
        $('#admin_create_referral_link-button').prop('disabled', true);
		$('#admin_create_referral_link-button').hide();
		$('#admin_create_referral_link-loading').show();
        $('#admin-referral_link_comment-error').hide();
		$('#admin_create_referral_link-success').hide();
    },
    success: function(result) {
        $('#admin_create_referral_link-button').prop('disabled', false);
		$('#admin_create_referral_link-button').show();
		$('#admin_create_referral_link-loading').hide();
		
        if (result.status == 'success') {
		$('#referral_link_comment').val('');
		$('#admin_create_referral_link-success').html(result.message);
		$('#admin_create_referral_link-success').show();
		return true;}
        if (result.status == 'comment') {
        $('#admin-referral_link_comment-error').html(result.message);
        $('#admin-referral_link_comment-error').show();
        }
