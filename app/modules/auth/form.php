		...
		<div class="container">
			<div class="top__right">
				...
				<ul class="menu top__block">
					<li class="menu__item"><a class="menu__link" href="<?=$product['url_main']?>"><?=$lng['menu_main_website']?></a></li>
				</ul>
			...
			<input type="hidden" name="do" value="signin">
				<div class="form__content">
					...
					<div class="text--center" style="margin-bottom: 30px;">
						<a class="btn btn--buy text--center" href="/signup/"><?=$lng['auth_signup_link']?></a>
					</div>
